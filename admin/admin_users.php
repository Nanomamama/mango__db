...
<style>
    ...
    .user-card-header {
        padding: 1rem 1.5rem;
        background: linear-gradient(90deg, rgba(1, 106, 112, 0.08), transparent);
    ...
    .user-avatar {
        ...
        box-shadow: 0 4px 10px rgba(1, 106, 112, 0.2);
    }
    ...
    .search-box input:focus {
        box-shadow: 0 4px 15px rgba(1, 106, 112, 0.2);
...
<div class="modal fade user-modal" id="loginHistoryModal" tabindex="-1" aria-labelledby="loginHistoryModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body" id="loginHistoryModalBody"></div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body" id="activityModalBody">
        ...
        <div id="activityTimelineContainer"></div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ปิด</button>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="userDetailTable"></table>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ปิด</button>
        ...
        activityModal.querySelectorAll('#activityFilterButtons button').forEach(filterButton => {
            filterButton.addEventListener('click', function() {
                ...
                timelineItems.forEach(item => {
                    item.style.display = filterType === 'all' || item.getAttribute('data-activity-type') === filterType ? 'block' : 'none';
                });
            });
        });
    }
    ...
    if (searchInput) {
        searchInput.addEventListener('keyup', function() {
            ...
            document.querySelectorAll('.user-card').forEach(card => {
                ...
                card.parentElement.style.display = name.includes(searchText) || email.includes(searchText) ? 'block' : 'none';
            });
        });
    }
