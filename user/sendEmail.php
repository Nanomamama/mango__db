                ...
                <div style='padding: 30px; background-color: #ffffff;'>
                    ...
                    <table style='width: 100%; border-collapse: collapse; font-size: 14px; margin-bottom: 25px;'>
                        ...
                        <tr>
                            ...
                            <td style='padding: 8px 0; font-weight: 600;'>" . date('d/m/Y H:i') . " น.</td>
                        </tr>
                    </table>
                ...
                <div style='padding: 30px; line-height: 1.6; color: #374151;'>
                    ...
                    <div style='background: #fdfdfd; padding: 25px; border-radius: 8px; border: 1px solid #e5e7eb; margin: 25px 0;'>
                        ...
                        <ul style='margin: 10px 0; padding-left: 20px; color: #4b5563;'>
                            <li style='margin-bottom: 10px;'><b>ตรวจสอบสถานะ:</b> เจ้าหน้าที่จะแจ้งยืนยันความว่างของสถานที่ผ่านทางอีเมลภายใน 24 ชม.</li>
                            <li style='margin-bottom: 10px;'><b>ชำระค่าธรรมเนียม:</b> หากวันดังกล่าวว่าง ท่านจะได้รับ QR Code ผ่านทางอีเมล เพื่อชำระเงินมัดจำ 30%</li>
                            <li style='margin-bottom: 10px;'><b>ส่งหลักฐาน:</b> กรุณาชำระเงินและแนบหลักฐานในระบบทันที </li>
                        </ul>
                        
                        <div style='background: #fef2f2; border-left: 4px solid #ef4444; padding: 12px 15px; margin-top: 15px;'>
                            <p style='margin: 0; color: #991b1b; font-size: 14px;'>
                                <strong>⚠️ ข้อควรทราบ:</strong> หากไม่มีการชำระมัดจำภายใน 3 วันหลังจากได้รับ QR Code ระบบจะขออนุญาตยกเลิกการจองของท่านโดยอัตโนมัติ
                            </p>
                        </div>
                    </div>
